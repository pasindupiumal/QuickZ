...
public class RecorderHome extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startRecording() {
        ...
        File file = new File(root.getAbsolutePath() + "/VoiceRecorder/Records");
        if (!file.exists()) {
            file.mkdirs();
        }

        fileName =  root.getAbsolutePath() + "/VoiceRecorder/Records/" + String.valueOf(System.currentTimeMillis() + ".mp3");
